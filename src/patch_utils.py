    ...
    if is_zimage:
        ...
        def dype_patchify_and_embed(self, x, cap_feats, cap_mask, t, num_tokens, transformer_options={}):
            ...
            if hasattr(self, "rope_embedder") and hasattr(self.rope_embedder, "set_grid_hw"):
                inv_h_scale = 1.0 / max(h_scale, 1e-8)
                inv_w_scale = 1.0 / max(w_scale, 1e-8)
                self.rope_embedder.set_grid_hw((H_tokens, W_tokens), getattr(self, "_dype_base_hw", None), (inv_h_scale, inv_w_scale))
